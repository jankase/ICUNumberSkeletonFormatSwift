...
/// Formatting strategy for permille (per thousand) values.
public struct PermilleFormattingStrategy: NumberFormattingStrategy {

    /// The permille symbol (per thousand).
    private static let permilleSymbol = "\u{2030}" // ‰
    ...
    public func format(_ value: Double, options: SkeletonOptions, locale: Locale) -> String {
        ...
        return formattedNumber + Self.permilleSymbol
    }
